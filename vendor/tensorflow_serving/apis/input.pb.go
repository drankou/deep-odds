...
import (
	...
	example_protos_go_proto "github.com/tensorflow/tensorflow/tensorflow/go/core/example/example_protos_go_proto"
...
func (x *ExampleListWithContext) GetExamples() []*example_protos_go_proto.Example {
	if x != nil {
		return x.Examples
	}
	return nil
...
func (x *ExampleListWithContext) GetContext() *example_protos_go_proto.Example {
	if x != nil {
		return x.Context
	}
	return nil
...
var file_tensorflow_serving_apis_input_proto_goTypes = []interface{}{
	...
	(*example_protos_go_proto.Example)(nil), // 3: tensorflow.Example
}
